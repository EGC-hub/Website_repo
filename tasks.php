        ...
        <?php if ($result->num_rows > 0): ?>
            <table class="task-table">
                <tr>
                    ...
                    <th>End Date</th>
                    <th>Status</th>
                    <?php if ($user_role !== 'user'): ?><th>Assigned To</th><?php endif; ?>
                    <th>Created At</th>
                    <?php if ($user_role !== 'user'): ?><th>Actions</th><?php endif; ?>
                </tr>
                ...
                <tr>
                    ...
                    <?php if ($user_role !== 'user'): ?><td><?php echo htmlspecialchars($row['assigned_to']); ?></td><?php endif; ?>
