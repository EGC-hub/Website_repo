                        ...
                        <td>
                            ...
                            <?php elseif ($row['status'] === 'Delayed Completion'): ?>
                                ...
                                <a href="#" data-bs-toggle="modal" data-bs-target="#delayedCompletionModal"
                                    onclick="showDelayedDetails('<?php echo htmlspecialchars($row['task_name']); ?>', '<?php echo htmlspecialchars($row['completion_date']); ?>', '<?php echo htmlspecialchars($row['delay_reason']); ?>',)">
                                    <?php echo htmlspecialchars($row['task_name']); ?>
                                </a>
                            <?php else: ?>
