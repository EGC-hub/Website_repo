...
CREATE TABLE `projects` (
  ...
  `status` enum('No Tasks', 'Assigned', 'In Progress', 'Completed') DEFAULT 'No Tasks',
...
ADD
  UNIQUE KEY `uk_project_name_department` (`project_name`, `department_id`),
ADD
  KEY `fk_projects_user` (`created_by_user_id`),
ADD
  KEY `idx_projects_department_id` (`department_id`),
ADD
  KEY `idx_projects_project_code` (`project_code`);
...
ADD
  KEY `fk_task_timeline_task` (`task_id`),
ADD
  KEY `fk_task_timeline_user` (`changed_by_user_id`);
...
ADD
  KEY `fk_task_transactions_task` (`task_id`);
...
--
-- Indexes for table `user_deletion_audit`
--
ALTER TABLE
  `user_deletion_audit`
ADD
...
ADD
  KEY `fk_user_departments_department` (`department_id`);
...
--
-- AUTO_INCREMENT for table `user_deletion_audit`
--
ALTER TABLE
  `user_deletion_audit`
MODIFY
...
ADD
  CONSTRAINT `fk_projects_user` FOREIGN KEY (`created_by_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
ALTER TABLE
  `task_attachments`
ADD
  CONSTRAINT `task_attachments_ibfk_1` FOREIGN KEY (`task_id`) REFERENCES `tasks` (`task_id`),
ADD
  CONSTRAINT `task_attachments_ibfk_2` FOREIGN KEY (`uploaded_by_user_id`) REFERENCES `users` (`id`);
...
ALTER TABLE
  `task_deletion_reasons`
ADD
  CONSTRAINT `task_deletion_reasons_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
...
ALTER TABLE
  `task_timeline`
ADD
  CONSTRAINT `fk_task_timeline_task` FOREIGN KEY (`task_id`) REFERENCES `tasks` (`task_id`) ON DELETE CASCADE,
ADD
  CONSTRAINT `fk_task_timeline_user` FOREIGN KEY (`changed_by_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
ALTER TABLE
  `task_transactions`
ADD
  CONSTRAINT `fk_task_transactions_task` FOREIGN KEY (`task_id`) REFERENCES `tasks` (`task_id`) ON DELETE CASCADE;

--
-- Constraints for table `user_deletion_audit`
--
ALTER TABLE
  `user_deletion_audit`
ADD
  CONSTRAINT `user_deletion_audit_ibfk_2` FOREIGN KEY (`deleted_by`) REFERENCES `users` (`id`);
